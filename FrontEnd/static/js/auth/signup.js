...
//     let isDefaultImage = true; // Bandera para saber si es la imagen predeterminada
//
...
//         isDefaultImage = true;  // Se establece como la imagen predeterminada
//         btnClearCanvas.style.display = 'none'; // No mostrar la X si es la imagen predeterminada
//     };
//
...
//             image.onload = function () {
//                 drawImageToCanvas(image);
//                 isDefaultImage = false;  // Se subió una nueva imagen, no es la predeterminada
//                 btnClearCanvas.style.display = 'block';  // Mostrar la X cuando se sube una imagen nueva
//             };
//         };
...
//         isDefaultImage = false;  // Ya no es la imagen predeterminada
//         if (videoStream) {
...
//         ctx.clearRect(0, 0, canvas.width, canvas.height);
//         btnClearCanvas.style.display = 'none'; // Ocultar la X al limpiar el canvas
//
...
//         image.onload = function () {
//             drawImageToCanvas(image);
//             isDefaultImage = true;  // Volver a la imagen predeterminada
//         };
//
